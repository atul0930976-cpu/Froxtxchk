...
# New API endpoint
API_BASE_URL = "https://autosh-production-4656.up.railway.app/?"

# Group IDs for hit detection notifications
HIT_DETECTION_GROUP_ID = -1003694167299
...
def format_mass_response(result: Dict, user_info: Dict) -> Tuple[str, str]:
    ...
    card_part = f"<a href='https://t.me/Froxt731'>⊀</a> 𝐂𝐚𝐫𝐝\n⤷ <code>{card_details}</code>"
    
    gateway_part = f"<a href='https://t.me/Froxt731'>⊀</a> 𝐆𝚊𝐭𝐞𝐰𝚊𝐲 ↬ <i><b>{gateway}</b></i>"
    
    response_part = f"<a href='https://t.me/Froxt731'>⊀</a> 𝐑𝐞𝐬𝐩𝐨𝐧𝐬𝐞 ↬ <b>{response_text}</b>"
    
    price_part = f"<a href='https://t.me/Froxt731'>⊀</a> 𝐏𝐫𝐢𝐜𝐞 ↬ <b>{price} USD</b>"
    
    bank_part = f"<pre>𝑩𝒓𝒂𝒏𝒌 ↬ <code>{brand}</code>\n𝑩𝒂𝒏𝒌 ↬ <code>{issuer}</code>\n𝑪𝒐𝒖𝒏𝒕𝒓𝒚 ↬ <code>{country_name} {country_flag}</code></pre>"
    
    user_part = f"<a href='https://t.me/Froxt731'>⌬</a> 𝐔𝐬𝐞𝐫 ↬ <a href='tg://user?id={user_id}'>{first_name}</a> <code>[{user_tier}]</code>"
    
    proxy_emoji = "🟢" if proxy_status.lower() == "live" else "🔴"
    proxy_part = f"<a href='https://t.me/Froxt731'>⌬</a> 𝐏𝐱 ↬ {proxy_emoji}"    
    
    # Add developer part with hyperlink
    dev_part = f"<a href='https://t.me/Froxt731'>⌬</a> 𝐃𝐞𝐯 ↬ <a href='https://t.me/DARK_FROXT_73'>Froxt Atul</a> / {proxy_part}"
...
def format_hit_detected_message(result: Dict, user_info: Dict) -> str:
    ...
    status_part = f"""<pre><a href='https://t.me/Froxt731'>⩙</a> <b>𝑯𝒊𝒕 𝑫𝒆𝒕𝒄𝒕𝒆𝒅</b> ↬ {status_style}</pre>"""
    
    # Combine all parts
    hit_message = f"""{status_part}
<a href='https://t.me/Froxt731'>⊀</a> <b>𝐆𝚊𝐭𝐞𝐰𝚊𝐲</b> ↬ <i><b>{gateway}</b></i>
<a href='https://t.me/Froxt731'>⊀</a> 𝐏𝐫𝐢𝐜𝐞 ↬ <b>{price} USD</b>
<a href='https://t.me/Froxt731'>⊀</a> <b>𝐑𝐞𝐬𝐩𝐨𝐧𝐬𝐞</b> ↬ <b>{response_text}</b>
...
<a href='https://t.me/Froxt731'>⊀</a> 𝐒𝐞𝐬𝐬𝐢𝐨𝐧 𝐈𝐃 ↬ <code>{session_id}</code>
<a href='https://t.me/Froxt731'>⊀</a> 𝐆𝚊𝐭𝐞𝐰𝚊𝐲 ↬ Shopify Rnd. Charge
<a href='https://t.me/Froxt731'>⊀</a> 𝐓𝐨𝐭𝐚𝐥 𝐂𝐚𝐫𝐝𝐬 ↬ <code>{stats["total"]}</code>
<a href='https://t.me/Froxt731'>⊀</a> 𝐂𝐡𝐞𝐜𝐤𝐝 ↬ <code>{stats["checked"]}/{stats["total"]} ({percentage}%)</code>
<a href='https://t.me/Froxt731'>⊀</a> 𝐂𝐡𝐚𝐫𝐠𝐞𝐝 🔥 ↬ <code>{stats["charged"]}</code>
<a href='https://t.me/Froxt731'>⊀</a> 𝐀𝐩𝐩𝐫𝐨𝐯𝐞𝐝 ✅ ↬ <code>{stats["approved"]}</code>
<a href='https://t.me/Froxt731'>⊀</a> 𝐃𝐞𝐜𝐥𝐢𝐧𝐞𝐝 ❌ ↬ <code>{stats["declined"]}</code>
<a href='https://t.me/Froxt731'>⊀</a> 𝐄𝐫𝐫𝐨𝐫 𝐂𝚊𝐫𝐝𝐬 ⚠️ ↬ <code>{stats["error"]}</code>
<a href='https://t.me/Froxt731'>⌬</a> 𝐒𝐭𝐨𝐩 𝐂𝐨𝐦𝐚𝐧𝐝 ↬ <code>/stop {session_id}</code>
...
<a href='https://t.me/Froxt731'>⊀</a> 𝐆𝚊𝐭𝐞𝐰𝚊𝐲 ↬ Shopify Rnd. Charge
<a href='https://t.me/Froxt731'>⊀</a> 𝐓𝐨𝐭𝐚𝐥 𝐂𝐚𝐫𝐝𝐬 ↬ <code>{stats["total"]}</code>
<a href='https://t.me/Froxt731'>⊀</a> 𝐂𝐡𝐞𝐜𝐤𝐝 ↬ <code>{stats["checked"]}/{stats["total"]}</code>
<a href='https://t.me/Froxt731'>⊀</a> 𝐂𝐡𝐚𝐫𝐠𝐞𝐝 🔥 ↬ <code>{stats["charged"]}</code>
<a href='https://t.me/Froxt731'>⊀</a> 𝐀𝐩𝐩𝐫𝐨𝐯𝐞𝐝 ✅ ↬ <code>{stats["approved"]}</code>
<a href='https://t.me/Froxt731'>⊀</a> 𝐃𝐞𝐜𝐥𝐢𝐧𝐞𝐝 ❌ ↬ <code>{stats["declined"]}</code>
<a href='https://t.me/Froxt731'>⊀</a> 𝐄𝐫𝐫𝐨𝐫 𝐂𝚊𝐫𝐝𝐬 ⚠️ ↬ <code>{stats["error"]}</code>
<a href='https://t.me/Froxt731'>⊀</a> 𝐓𝐢𝐦𝐞 ↬ <code>{elapsed_time}s</code> ⏱️
<a href='https://t.me/Froxt731'>⊀</a> 𝐂𝐡𝐞𝐜𝐤 𝐁𝐲 ↬ <code>{user_name}</code>
<a href='https://t.me/Froxt731'>⌬</a> 𝐃𝐞𝐯 ↬ <a href='https://t.me/DARK_FROXT_73'>Froxt Atul</a>"""
...
<a href='https://t.me/Froxt731'>⊀</a> 𝐒𝐞𝐬𝐬𝐢𝐨𝐧 𝐈𝐃 ↬ <code>{session_id if session_id else 'N/A'}</code>
<a href='https://t.me/Froxt731'>⊀</a> 𝐆𝚊𝐭𝐞𝐰𝚊𝐲 ↬ Shopify Rnd. Charge
<a href='https://t.me/Froxt731'>⊀</a> 𝐓𝐨𝐭𝐚𝐥 𝐂𝐚𝐫𝐝𝐬 ↬ <code>{stats["total"]}</code>
<a href='https://t.me/Froxt731'>⊀</a> 𝐂𝐡𝐞𝐜𝐤𝐝 ↬ <code>{stats["checked"]}/{stats["total"]}</code>
<a href='https://t.me/Froxt731'>⊀</a> 𝐂𝐡𝐚𝐫𝐠𝐞𝐝 🔥 ↬ <code>{stats["charged"]}</code>
