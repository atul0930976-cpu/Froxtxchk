...
async def build_page_text(page_index: int, user_id: int) -> str:
    ...
    try:
        ...
        # Main Header
        text = f"<pre><a href='https://t.me/Froxt731'>⩙</a> <b>𝑨𝒖𝒂𝒊𝒎𝒂𝒏𝒅𝒔 𝑪𝒐𝒎𝒎𝒂𝒏𝒅𝒔</b> ↬ <i>Page {page_index + 1}/{len(PAGES)}</i></pre>\n"
        text += "━━━━━━━━━━━━━━━━━━━━\n"
        ...
        for name, cmd, cmd_type, desc, gate_name in page_commands:
            ...
            text += f"<pre><a href='https://t.me/Froxt731'>⊀</a> <b>𝑵𝒂𝒎𝒆</b> ↬ <i>{escape_html(name)}</i></pre>\n"
            text += f"<a href='https://t.me/Froxt731'>⊀</a> <b>𝑪𝒐𝒎𝒎𝒂𝒏𝒅</b> ↬ <i>{escape_html(cmd)}</i>\n"
            text += f"<a href='https://t.me/Froxt731'>⊀</a> <b>𝑰𝒏𝒇𝒐</b> ↬ <i>{escape_html(desc)}</i>\n"
            text += f"<a href='https://t.me/Froxt731'>⊀</a> <b>𝑺𝒕𝒂𝒕𝒖𝒔</b> ↬ <i>{status}</i>\n"
            text += f"<a href='https://t.me/Froxt731'>⊀</a> <b>𝑻𝒚𝒑𝒆</b> ↬ <i>{type_emoji} {cmd_type}</i>\n"
            text += "━━━━━━━━━━━━━━━━━━━━\n"
