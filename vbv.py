...
⤷ <code>{card_details}</code>"""
    ...
    if user_credits is not None and user_credits <= 0 and user_credits != float('inf'):
        credits_warning = f"\n<a href='https://t.me/Froxt731'>⚠️</a> <b>𝙇𝙤𝙬𝙠𝙚𝙙𝙞𝙣𝙜:</b> <i>You have 0 credits left. Please recharge to continue using this service.</i>"
    
    # Combine all parts
    formatted_response = f"""{status_part}
{card_part}
<a href='https://t.me/Froxt731'>⊀</a> <b>𝐆𝐚𝐭𝐞𝐰𝐚𝐲</b> ↬ <i>𝟯𝗗𝗦 𝗟𝗼𝗼𝗸𝘂𝗽</i>
...
<a href='https://t.me/Froxt731'>⚠️</a> <b>𝙇𝙚𝙬𝙠𝙚𝙙𝙞𝙣𝙜:</b> <i>You have 0 credits left. This will be your last check.</i>"""
    else:
            ...
            if result and not result.startswith("⚠️ <b>Missing card details!</b>") and not result.startswith("⚠️ <b>Error checking card:</b>"):
                ...
                if not is_unlimited:
                    ...
                    if updated_credits is not None and updated_credits <= 0:
                        ...
                        result = result + f"\n<a href='https://t.me/Froxt731'>⚠️</a> <b>𝙇𝙚𝙬𝙠𝙚𝙙𝙞𝙣𝙜:</b> <i>You have 0 credits left. Please recharge to continue using this service.</i>"
