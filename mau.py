...
HIT_DETECTION_GROUP_ID = -1003694167299  # Replace with your actual group ID
...
def format_response_stripe_auth(result: dict, user_info: dict) -> Tuple[str, str]:
    ...
    if "error" in result:
        ...
        formatted_error = f"""<a href='https://t.me/Froxt731'>⚠️</a> <b>𝙀𝙧𝙧𝙤𝙧 𝘿𝙚𝙩𝙚𝙘𝙩𝙚𝙙</b> ⚠️

<a href='https://t.me/Froxt731'>💳</a> <b>𝘾𝙖𝙧𝙙:</b> <code>{result.get('card_details', 'Unknown')}</code>

<a href='https://t.me/Froxt731'>📝</a> <b>𝙍𝙚𝙖𝙨𝙤𝙣:</b> <i>{error_msg}</i>

<a href='https://t.me/Froxt731'>💡</a> <b>𝙏𝙞𝙥:</b> <i>Please check your card details and try again.</i>"""
    ...
    status_part = f"""<pre><a href='https://t.me/Froxt731'>⩙</a> <b>𝑺𝒕𝒂𝒕𝒖𝒔</b> ↬ {status_style}</pre>"""
    
    bank_part = f"""<pre><b>𝑩𝒓𝒂𝒏𝒌</b> ↬ <code>{brand}</code>
<b>𝑩𝒓𝒂𝒏𝒌</b> ↬ <code>{issuer}</code>
<b>𝑪𝒐𝒖𝒏𝒕𝒓𝒚</b> ↬ <code>{country_name} {country_flag}</code></pre>"""
    
    card_part = f"""<a href='https://t.me/Froxt731'>⊀</a> <b>𝐂𝐚𝐫𝐝</b>
⤷ <code>{card_details}</code>"""
    
    # Combine all parts
    formatted_response = f"""{status_part}
{card_part}
<a href='https://t.me/Froxt731'>⊀</a> <b>𝐆𝐚𝐭𝐞𝐰𝐚𝐲</b> ↬ <i>𝘀𝘁𝗿𝗶𝗽𝗲 𝗔𝘂𝘁𝗵</i>
<a href='https://t.me/Froxt731'>⊀</a> <b>𝐑𝐞𝐬𝐩𝐨𝐧𝐬𝐞</b> ↬ <code>{message}</code>
{bank_part}
<a href='https://t.me/Froxt731'>⌬</a> <b>𝐔𝐬𝐞𝐫</b> ↬ {user_link} 
<a href='https://t.me/DARK_FROXT_73'>⌬</a> <b>𝐃𝐞𝐯</b> ↬ <a href='https://t.me/DARK_FROXT_73'>Froxt Atul</a>"""
...
def format_hit_detected_message(result: dict, user_info: dict) -> str:
    ...
    status_part = f"""<pre><a href='https://t.me/Froxt731'>⩙</a> <b>𝑯𝒊𝒕 𝒅𝒆𝒕𝒆𝒄𝒕𝒆𝒅</b> ↬ <b>𝘼𝙋𝙋𝙍𝙊𝙑𝙀𝘿</b> ✅</pre>"""
    
    # Combine all parts
    hit_message = f"""{status_part}
<a href='https://t.me/Froxt731'>⊀</a> <b>𝐆𝚊𝐭𝐞𝐰𝚊𝐲</b> ↬ <i>𝘀𝘁𝗿𝗶𝗽𝗲 𝗔𝘂𝘁𝗵</i>
<a href='https://t.me/Froxt731'>⊀</a> <b>𝐑𝐞𝐬𝐩𝐨𝐧𝐬𝐞</b> ↬ <code>{message}</code>
<a href='https://t.me/Froxt731'>⌬</a> <b>𝐔𝐬𝐞𝐫 ↬</b> ↬ {user_link} 
<a href='https://t.me/Froxt731'>⌬</a> <b>𝐇𝐢𝐭 𝐅𝐫𝐨𝐦</b> ↬ <a href='https://t.me/DARK_FROXT_73'>𝐅𝐑𝐎𝐗𝐓 ✘ 𝑪𝑯𝑲</a>"""
...
def format_progress_response(stats: Dict, session_id: str) -> Tuple[str, InlineKeyboardMarkup]:
    ...
    progress_msg = f"""<pre><a href='https://t.me/Froxt731'>⩙</a> <b>𝑺𝒕𝒂𝒕𝒖𝒔</b> ↬ <b>𝙿𝚛𝚘𝚌𝚎𝚜𝚜𝚒𝚗𝚐</b> 📊</pre>
<a href='https://t.me/Froxt731'>⊀</a> <b>𝐒𝐞𝐬𝐬𝐢𝐨𝐧 𝐈𝐃</b> ↬ <code>{session_id}</code>
<a href='https://t.me/Froxt731'>⊀</a> <b>𝐆𝐚𝐭𝐞𝐰𝐚𝐲</b> ↬ <i>𝘀𝘁𝗿𝗶𝗽𝗲 𝗔𝘂𝘁𝗵</i>
<a href='https://t.me/Froxt731'>⊀</a> <b>𝐓𝐨𝐭𝐚𝐥 𝐂𝐚𝐫𝐝𝐬</b> ↬ <code>{stats["total"]}</code>
<a href='https://t.me/Froxt731'>⊀</a> <b>𝐂𝐡𝐞𝐜𝐤𝐞𝐝</b> ↬ <code>{stats["checked"]}/{stats["total"]} ({percentage}%)</code>
<a href='https://t.me/Froxt731'>⊀</a> <b>✅ 𝐀𝐩𝐩𝐫𝐨𝐯𝐞𝐝</b> ↬ <code>{stats["approved"]}</code>
<a href='https://t.me/Froxt731'>⊀</a> <b>❌ 𝐃𝐞𝐜𝐥𝐢𝐧𝐞𝐝</b> ↬ <code>{stats["declined"]}</code>
<a href='https://t.me/Froxt731'>⊀</a> <b>⚠️ 𝐄𝐫𝐫𝐨𝐫 𝐂𝐚𝐫𝐝𝐬</b> ↬ <code>{stats["error"]}</code>
<a href='https://t.me/Froxt731'>⌬</a> <b>𝐒𝐭𝐨𝐩 𝐂𝐨𝐦𝐦𝐚𝐧𝐝</b> ↬ <code>/stop {session_id}</code>
<a href='https://t.me/DARK_FROXT_73'>⌬</a> <b>𝐃𝐞𝐯</b> ↬ <a href='https://t.me/DARK_FROXT_73'>Froxt Atul</a>"""
...
def format_stopped_response(stats: Dict, elapsed_time: float, user_name: str, session_id: str) -> str:
    ...
    stopped_msg = f"""<pre><a href='https://t.me/Froxt731'>⩙</a> <b>𝑺𝒕𝒂𝒕𝒖𝒔</b> ↬ <b>𝙎𝙩𝙤𝙥𝙥𝙚𝙙</b> ⏹️</pre>
<a href='https://t.me/Froxt731'>⊀</a> <b>𝐒𝐞𝐬𝐬𝐢𝐨𝐧 𝐈𝐃</b> ↬ <code>{session_id}</code>
<a href='https://t.me/Froxt731'>⊀</a> <b>𝐆𝐚𝐭𝐞𝐰𝐚𝐲</b> ↬ <i>𝘀𝘁𝗿𝗶𝗽𝗲 𝗔𝘂𝘁𝗵</i>
<a href='https://t.me/Froxt731'>⊀</a> <b>𝐓𝐨𝐭𝐚𝐥 𝐂𝐚𝐫𝐝𝐬</b> ↬ <code>{stats["total"]}</code>
<a href='https://t.me/Froxt731'>⊀</a> <b>𝐂𝐡𝐞𝐜𝐤𝐞𝐝</b> ↬ <code>{stats["checked"]}/{stats["total"]}</code>
<a href='https://t.me/Froxt731'>⊀</a> <b>✅ 𝐀𝐩𝐩𝐫𝐨𝐯𝐞𝐝</b> ↬ <code>{stats["approved"]}</code>
<a href='https://t.me/Froxt731'>⊀</a> <b>❌ 𝐃𝐞𝐜𝐥𝐢𝐧𝐞𝐝</b> ↬ <code>{stats["declined"]}</code>
<a href='https://t.me/Froxt731'>⊀</a> <b>⚠️ 𝐄𝐫𝐫𝐨𝐫 𝐂𝐚𝐫𝐝𝐬</b> ↬ <code>{stats["error"]}</code>
<a href='https://t.me/Froxt731'>⊀</a> <b>𝑻𝒊𝒎𝒆</b> ↬ <code>{elapsed_time}s</code> ⏱️
<a href='https://t.me/Froxt731'>⌬</a> <b>𝐂𝐡𝐞𝐜𝐤 𝐁𝐲</b> ↬ <code>{user_name}</code>
<a href='https://t.me/DARK_FROXT_73'>⌬</a> <b>𝐃𝐞𝐯</b> ↬ <a href='https://t.me/DARK_FROXT_73'>Froxt Atul</a>"""
...
def format_final_response(stats: Dict, elapsed_time: float, user_name: str, stopped: bool = False, session_id: str = None) -> str:
    ...
    final_msg = f"""<pre><a href='https://t.me/Froxt731'>⩙</a> <b>{header_text}</b> ↬ {status_text}</pre>
<a href='https://t.me/Froxt731'>⊀</a> <b>𝐒𝐞𝐬𝐬𝐢𝐨𝐧 𝐈𝐃</b> ↬ <code>{session_id if session_id else 'N/A'}</code>
<a href='https://t.me/Froxt731'>⊀</a> <b>𝐆𝐚𝐭𝐞𝐰𝐚𝐲</b> ↬ <i>𝘀𝘁𝗿𝗶𝗽𝗲 𝗔𝘂𝘁𝗵</i>
<a href='https://t.me/Froxt731'>⊀</a> <b>𝐓𝐨𝐭𝐚𝐥 𝐂𝐚𝐫𝐝𝐬</b> ↬ <code>{stats["total"]}</code>
<a href='https://t.me/Froxt731'>⊀</a> <b>𝐂𝐡𝐞𝐜𝐤𝐞𝐝</b> ↬ <code>{stats["checked"]}/{stats["total"]}</code>
<a href='https://t.me/Froxt731'>⊀</a> <b>✅ 𝐀𝐩𝐩𝐫𝐨𝐯𝐞𝐝</b> ↬ <code>{stats["approved"]}</code>
