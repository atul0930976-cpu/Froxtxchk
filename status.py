    ...
    try:
        ...
        if sys_info.get("error"):
            error_message = (
                ...
                f"{BULLET_LINK} 𝐁𝐨𝐭 𝐁𝐲 {ARROW_RIGHT} <a href='tg://resolve?domain=FroxtAtul'>Froxt Atul</a>\n"
            )
        ...
        status_message += f"\n{SECTION_DIVIDER}\n{BULLET_LINK} <b>𝐁𝐨𝐭 𝐁𝐲</b> {ARROW_RIGHT} <a href='tg://resolve?domain=FroxtAtul'>Froxt Atul</a>"
