...
BOT_TOKEN = "8728907005:AAHv-chb9LnpGrtg5Kc95WxKVFl3oHBUTMQ"
SESSION_STRING = "BQIb648AfNhh5RKwwXD7Gpwk6by5gyX5UmXqOrvEYcy0HQIGCm1joK-fNfyglX_XB7ZKdXup37Indk1WXjVLxn1lgacErRUn5_mDGVqSTMoY6Ww-RJGNEI73Q0CtpOpicWqp9vwC7G3gE9PmD3dXL4n59rqUy25e6HjlDYonABHbatBCm6RRoKXzfRGoAC6KrKzqPjaCaOrRJxNKKJkX6Hl4n57CX3mNzJ8O2lXctQiPJRQzRzqgeVCbiptVXbwYr4mSU9WgKkFaAbgsq7JBX-eUUrIj7hgWlfBsTdyM-4FRMsfd_mr4J4xo94lOLyVbsoQC9FILmzDtFq2Y5lMbmXSHtT3LvwAAAAHowfzxAA"
...
def format_scr_response(results: Dict, user_info: Dict) -> str:
    ...
    status_part = f"""<pre><a href='https://t.me/Froxt731'>⩙</a> <b>𝑺𝒕𝒂𝒕𝒖𝒔</b> ↬ <b>𝑪𝒐𝒎𝒑𝒍𝒆𝒕𝒆𝒅</b> ✅</pre>"""
    
    source_part = f"""<a href='https://t.me/Froxt731'>⌬</a> <b>𝑺𝒐𝒖𝒓𝒄𝒆</b> ↬ <code>{source}</code>"""
    
    # Use bullet points for cards found and duplicates removed
    cards_part = f"""<a href='https://t.me/Froxt731'>⊀</a> <b>𝑪𝒂𝒓𝒅𝒔 𝑭𝒐𝒖𝒏𝒅</b> ↬ <code>{cards_found}</code>
<a href='https://t.me/Froxt731'>⊀</a> <b>𝑫𝒖𝒑𝒍𝒊𝒄𝒂𝒕𝒆𝒔 𝑹𝒆𝒎𝒐𝒗𝒆𝒅</b> ↬ <code>{duplicates_removed}</code>"""
    
    filter_part = ""
    if bin_filter:
        filter_part += f"<a href='https://t.me/Froxt731'>⊀</a> <b>𝑩𝑰𝑵 𝑭𝒊𝒍𝒕𝒆𝒓</b> ↬ <code>{bin_filter}</code>"
    if bank_filter:
        filter_part += f"<a href='https://t.me/Froxt731'>⊀</a> <b>𝑩𝒂𝒏𝒌 𝑭𝒊𝒍𝒕𝒆𝒓</b> ↬ <code>{bank_filter}</code>"
    ...
    if user_credits is not None and user_credits <= 0 and user_credits != float('inf'):
        credits_warning = f"\n<a href='https://t.me/Froxt731'>⚠️</a> <b>𝙒𝙖𝙧𝙣𝙞𝙣𝙜:</b> <i>You have 0 credits left. Please recharge to continue using this service.</i>"
...
async def handle_scr_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not has_credits:
        await update.message.reply_text(
            f"""<a href='https://t.me/Froxt731'>⚠️</a> <b>𝙒𝙖𝙧𝙣𝙞𝙣𝙜:</b> <i>You have 0 credits left.</i>

<a href='https://t.me/Froxt731'>💳</a> <b>Please recharge to continue using this service.</b>

<a href='https://t.me/Froxt731'>📊</a> <b>Current Plan:</b> <code>{user_tier}</code>
<a href='https://t.me/Froxt731'>💰</a> <b>Credits:</b> <code>0</code>""",
            parse_mode=ParseMode.HTML
        )
        return
...
<a href='https://t.me/Froxt731'>⊀</a> <b>𝑺𝒐𝒖𝒓𝒄𝒆</b> ↬ <code>{channel_name}</code>
<a href='https://t.me/Froxt731'>⊀</a> <b>𝑳𝒊𝒎𝒊𝒕</b> ↬ <code>{limit}</code>
<a href='https://t.me/Froxt731'>⊀</a> <b>𝑭𝒊𝒍𝒕𝒆𝒓</b> ↬ <code>{bin_filter or bank_filter or 'None'}</code>"""
