...
def format_response(api_response: str, user_info: Dict, card_details: str, 
    ...
    status_part = f"""<pre><a href='https://t.me/Froxt731'>⩙</a> <b>𝑺𝒕𝒂𝒕𝒖𝒔</b> ↬ <b>{status_text}</b> {status_emoji}</pre>"""
...
{card_part}
<a href='https://t.me/Froxt731'>⊀</a> <b>𝐆𝐚𝐭𝐞𝐰𝐚𝐲</b> ↬ <i>𝗦𝘁𝗿𝗶𝗽𝗲 0.50$</i>
<a href='https://t.me/Froxt731'>⊀</a> <b>𝐑𝐞𝐬𝐩𝐨𝐧𝐬𝐞</b> ↬ <code>{api_response}</code>
{bank_part}
...
async def handle_st_command(update, context):
    ...
    if not has_credits:
        await update.message.reply_text(
            f"<a href='https://t.me/Froxt731'>⚠️</a> <b>𝙄𝙣𝙨𝙪𝙛𝙛𝙞𝙘𝙞𝙚𝙣𝙩 𝘾𝙧𝙚𝙙𝙞𝙩𝙨:</b>\n\n"
