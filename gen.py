...
def format_cards_with_bin_info(cards: List[str], bin_info: Dict) -> str:
    ...
    header = f"""<pre><a href='https://t.me/Froxt731'>⩙</a> <b>𝑺𝒕𝒂𝒕𝒖𝒔</b> ↬ <b>{len(cards)} 𝘾𝙖𝙧𝙙𝙨</b> ✅</pre>
...
def format_bin_info_for_caption(bin_info: Dict, bin_pattern: str, amount: int) -> str:
    ...
    return f"""<pre><a href='https://t.me/Froxt731'>⩙</a> <b>𝑺𝒕𝒂𝒕𝒖𝒔</b> ↬ <b>𝐂𝐨𝐦𝐩𝐥𝐞𝐭𝐞</b> ✅</pre>
<a href='https://t.me/Froxt731'>⊀</a> <b>𝐆𝐞𝐧𝐞𝐫𝐚𝐭𝐞</b> ↬ <code>{amount}</code> <b>cards</b>
<a href='https://t.me/Froxt731'>⊀</a> <b>𝐁𝐢𝐧</b> ↬ <code>{bin_pattern[:6]}</code>
    ...
    try:
        ...
        if amount > 10:
            ...
            progress_message = await update.message.reply_text(
                f"<pre><a href='https://t.me/Froxt731'>⩙</a> <b>𝑺𝒕𝒂𝒕𝒖𝒔</b> ↬ <b>𝐆𝐞𝐧𝐞𝐫𝐚𝐭𝐢𝐧𝐠</b> ⏳</pre>\n"
                f"<a href='https://t.me/Froxt731'>⊀</a> <b>𝐆𝐞𝐧𝐞𝐫𝐚𝐭𝐢𝐧𝐠</b> ↬ <code>{amount}</code> <b>cards</b>\n"
                f"<a href='https://t.me/Froxt731'>⊀</a> <b>𝐁𝐢𝐧</b> ↬ <code>{bin_pattern[:6]}</code>\n"
                f"<a href='https://t.me/Froxt731'>⚠️</a> <i>Generating {amount} cards... This may take a few seconds.</i>",
                parse_mode="HTML"
            )
        ...
        if not is_unlimited:
            ...
            if updated_credits is not None and updated_credits <= 0:
                ...
                await update.message.reply_text(
                    f"<a href='https://t.me/Froxt731'>⚠️</a> <b>𝙒𝙖𝙧𝙣𝙚𝙧𝙖𝙩𝙚</b> <i>You have 0 credits left. Please recharge to continue using this service.</i>",
                    parse_mode="HTML"
                )
