...
GROUP_USERNAME = "+IFFnzNZuHFU5YmQ0"      # no +

CHANNEL_ID = -1003332800094
CHANNEL_USERNAME = "+E6zoRhIFhtNmM2E5"    # no +

FORCE_JOIN_IMAGE = "https://i.ibb.co/TMNcp89J/IMG-1474.png"
...
def force_join(func):
    ...
    async def wrapper(update: Update, context: ContextTypes.DEFAULT_TYPE, *args, **kwargs):
        ...
        if not joined:
            ...
            keyboard = [
                [InlineKeyboardButton("📢 Join Group", url=f"https://t.me/+hHylRLru9js1ODk1")],
                [InlineKeyboardButton("📡 Join Channel", url=f"https://t.me/+_YTsAzAEXDYwZDJl")],
