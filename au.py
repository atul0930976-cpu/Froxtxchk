...
{card_part}
<a href='https://t.me/Froxt731'>⊀</a> <b>𝐆𝐚𝐭𝐞𝐰𝐚𝐲</b> ↬ <i>𝗦𝘁𝗿𝗶𝗽𝗲 𝗔𝘂𝘁𝗵</i>
...
async def handle_au_command(update, context):
    ...
    if not card_details:
        await update.message.reply_text(
            """<a href='https://t.me/Froxt731'>⚠️</a> <b>𝙈𝙞𝙨𝙨𝙞𝙣𝙜 𝘾𝙖𝙧𝙙 𝘿𝙚𝙩𝙖𝙞𝙡𝙨</b>

<a href='https://t.me/Froxt731'>📝</a> <b>𝙐𝙨𝙖𝙜𝙚 𝙊𝙥𝙩𝙞𝙤𝙣𝙨:</b>
...
<a href='https://t.me/Froxt731'>💡</a> <b>𝙎𝙪𝙥𝙥𝙤𝙧𝙩𝙚𝙙 𝙁𝙤𝙧𝙢𝙖𝙩𝙨:</b>
...
<code>card:mm:yy:cvv</code>""",
    ...
    if not parsed:
        await update.message.reply_text(
            """<a href='https://t.me/Froxt731'>⚠️</a> <b>𝙄𝙣𝙫𝙖𝙡𝙞𝙙 𝙁𝙤𝙧𝙢𝙖𝙩</b>
...
<i>Could not parse card details. Please ensure the format is correct.</i>""",
    ...
    if not luhn_check(card_number):
        await update.message.reply_text(
            """<a href='https://t.me/Froxt731'>⚠️</a> <b>𝙄𝙣𝙫𝙖𝙡𝙞𝙙 𝘾𝙖𝙧𝙙</b>
...
𝐆𝐚𝐭𝐞𝐰𝐚𝐲 ↬ <i>𝗦𝘁𝗿𝗶𝗽𝗲 𝗔𝘂𝘁𝗵</i>"""
    ...
    async def background_check():
        try:
            ...
            error_msg = f"""<a href='https://t.me/Froxt731'>⚠️</a> <b>𝙀𝙧𝙧𝙤𝙧 𝘿𝙪𝙧𝙞𝙣𝙜 𝙋𝙧𝙤𝙘𝙚𝙨𝙨𝙞𝙣𝙜</b>

<a href='https://t.me/Froxt731'>📝</a> <b>𝘿𝙚𝙩𝙖𝙞𝙡𝙨:</b> <code>An unexpected error occurred</code>

<a href='https://t.me/Froxt731'>💡</a> <b>𝙎𝙪𝙜𝙜𝙚𝙨𝙩𝙞𝙤𝙣:</b> <i>Please try again later.</i>"""
